...
{****************************************************************************
 ...
 <This an unofficial, modified FPK Pascal source code file by KO Myung-Hun.>
...
Changelog:
    ...
    99/07/04        modified TFileStatus to             KOMH
                    TFileStatus0 because TFileStatus3
                    included a new field,
                    NextEntryOffset and new TFileStatus3
                    needed compatibility with previous
                    source code.
                    modifed TFileStatus3 to include
                    NextEntryOffset field at first.
    ...
    99/05/16        Type of parameter is corrected,     KOMH
                    'word' to 'longint'.
    People:
